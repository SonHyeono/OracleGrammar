...
select ename, deptno, sal from emp where hiredate = '83/01/12';  --없는데???
...
select * from emp where not between 7654 and 7782;
...
select empno from emp where deptno = 30 order by empno asc;
